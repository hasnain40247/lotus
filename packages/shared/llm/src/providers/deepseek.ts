...
const streamViaAISDK = (
  ...
  async function* produce(): AsyncGenerator<LLMEvent> {
    ...
    // v4-flash defaults to adaptive thinking; the user wants it off for the
    // fast model. Other DeepSeek models (v4-pro, reasoner) keep their default.
