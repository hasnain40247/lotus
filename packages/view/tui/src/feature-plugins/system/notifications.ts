import type { Event } from "@gco/sdk/v2"
...
function notify(api: TuiPluginApi, sessionID: string | undefined, message: string) {
...
const tui: TuiPlugin = async (api) => {
  ...
  api.event.on("permission.asked", (event) => {
    ...
    notify(api, event.properties.sessionID, "Permission needs input")
  })
